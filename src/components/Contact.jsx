...
//           position: "bottom-center", // moved to bottom
//           autoClose: 3000,
//           theme: "dark",
//           style: {
//             border: "1px solid #33d0beff",
//             background: "#1a1a2e",
//             color: "#33d0beff",
//           },
//         });
...
// ===== Styled Components =====
const Section = styled.section`
  padding: 2rem 1rem; /* decreased from 3rem */
  background: transparent;
  color: white;
  min-height: 60vh; /* decreased from 80vh */
  display: flex;
  flex-direction: column;
  align-items: center;
`;
...
const SectionHeading = styled.h1`
  ...
  &::after {
    ...
    height: 3px;
    background: linear-gradient(90deg, transparent, #33d0be, transparent);
    position: absolute;
    bottom: -8px;
    left: 50%;
    transform: translateX(-50%);
...
const Box = styled.div`
  background: #14142f;
  padding: 1.5rem; /* decreased from 2rem */
  border-radius: 16px;
  border: 2px solid rgba(51, 208, 190, 0.2);
  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.25); /* slightly smaller shadow */
  transition: all 0.3s ease;

  &:hover {
    border-color: rgba(51, 208, 190, 0.4);
    box-shadow: 0 8px 25px rgba(51, 208, 190, 0.2);
...
const Detail = styled.div`
  display: flex;
  align-items: center;
  gap: 0.6rem; /* slightly smaller */
  margin-bottom: 0.8rem; /* decreased */
  padding: 0.6rem; /* decreased */
  border-radius: 8px;
  background: rgba(51, 208, 190, 0.05);
  transition: all 0.3s ease;
...
const Button = styled.button`
  padding: 0.65rem 1.2rem; /* smaller */
  border-radius: 8px;
  background: linear-gradient(135deg, #33d0be, #20b2ca);
  color: white;
  font-weight: 600;
  cursor: pointer;
  border: none;
  ...
  &:hover {
    background: linear-gradient(135deg, #20b2ca, #33d0be);
    transform: translateY(-1.5px);
    box-shadow: 0 3px 10px rgba(51, 208, 190, 0.4);
  }
